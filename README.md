...
- `js/library.js` — índice das suas playlists pra busca "?texto tudo" (guardado no aparelho)
- `js/pins.js` — playlists fixadas no topo (guardadas na playlist escondida "⚙ fixadas")
